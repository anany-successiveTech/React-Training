...
const NavbarDrawer = () => {
  ...
  const questionsPerAssignment = 5;
  ...
  sx={{
    ...
    "& .MuiDrawer-paper": {
      ...
      backgroundColor: theme === "light" ? "#fff" : "#121212", // light or dark background
              ...
              <List component="div" disablePadding>
                {assignments.map((assignmentNo) => (
                  <React.Fragment key={assignmentNo}>
                    <ListItemButton sx={{ pl: 4 }} onClick={() => handleAssignmentClick(assignmentNo)}>
                      <ListItemText primary={`Assignment ${assignmentNo}`} />
                      {activeAssignment === assignmentNo ? <ExpandLess /> : <ExpandMore />}
                    </ListItemButton>

                    <Collapse in={activeAssignment === assignmentNo} timeout="auto" unmountOnExit>
                      <List component="div" disablePadding>
                        {[...Array(questionsPerAssignment)].map((_, i) => (
                          <ListItemButton
                            sx={{ pl: 6 }}
                            key={i}
